...
module.exports = {
  app: {
    title: 'British Columbia Mine Information',
    description: 'Government of British Columbia Major Mines Transparency Initiative',
    keywords: 'energy mines transparency initiative bc government',
