...
var artifacttypes = [
    ...
    { name: 'Memo to the Minister from the Associate Deputy Minister', phase: 'application-review', multiple: false, isTemplate: false, isDocument:true, code: 'memo-adm', milestone: 'memo-adm', versions : [ 'Final'], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'assessment-admin'}]},
    { name: 'Recommendations of the Executive Director', phase: 'application-review', multiple: false, isTemplate: false, isDocument: true, code: 'memo-epd', milestone: 'memo-epd', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'assessment-admin'}]},
    { name: 'Referral Package', phase: 'application-review', code: 'referral-package', milestone: 'referral-package', multiple: false, isTemplate: true, isDocument: false, versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'assessment-admin'}]},
];
