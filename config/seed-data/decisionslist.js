...
var artifacttypes = [
    { name: 'Application', multiple: false, isTemplate: false, isDocument: true, code: 'application', milestone: 'application', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'approve', prev: '', activity: 'edit'}, {name: 'Approval', next: 'publish', prev: 'edit', activity: 'approve', role: 'assessment-lead'}, {name: 'Publishing', next: '', prev: 'approve', activity: 'publish', role: 'assessment-admin'}]},
    ...
    { name: 'Documents', multiple: true, isTemplate: false, isDocument: false, code: 'documents', milestone: 'documents', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publishing', next: '', prev: 'edit', activity: 'publish', role: 'assessment-admin'}]},
    { name: 'Environmental Assessment Certificate Template',milestone: 'environmental-assessment-certificate',code: 'environmental-assessment-certificate',multiple: false,versions: ['Draft','Final'],phase: '', stages: [{name: 'Edit', next: 'review', prev: '', activity: 'edit'}, {name: 'Review', next: 'approve', prev: 'edit', activity: 'review', role: 'assessment-lead'}, {name: 'Approval', next: 'executive', prev: 'review', activity: 'approve', role: 'project-epd'}, {name: 'Executive Approval', next: 'decision', prev: 'approve', activity: 'executive', role: 'associate-dm'}, {name: 'Decision', next: 'publish', prev: 'executive', activity: 'decision', role: 'minister'}, {name: 'Publishing', next: '', prev: 'decision', activity: 'publish', role: 'assessment-admin'}]},
    ...
    { name: 'Recommendations of the Executive Director', multiple: false, isTemplate: false, isDocument: true, code: 'memo-epd', milestone: 'memo-epd', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'review', prev: '', activity: 'edit'}, {name: 'Review', next: 'approve', prev: 'edit', activity: 'review', role: 'project-epd'}, {name: 'Approval', next: 'executive', prev: 'review', activity: 'approve', role: 'assistant-dm'}, {name: 'Executive Approval', next: 'publish', prev: 'approve', activity: 'executive', role: 'associate-dm'}, {name: 'Publishing', next: '', prev: 'executive', activity: 'publish', role: 'assessment-admin'}]},
    { name: 'Referral Package', code: 'referral-package', milestone: 'referral-package', multiple: false, isTemplate: true, isDocument: false, versions : [ 'Final' ], stages: [{name: 'Edit', next: 'review', prev: '', activity: 'edit'}, {name: 'Review', next: 'approve', prev: 'edit', activity: 'review', role: 'assessment-lead'}, {name: 'Approval', next: 'executive', prev: 'review', activity: 'approve', role: 'project-epd'}, {name: 'Executive Approval', next: 'decision', prev: 'approve', activity: 'executive', role: 'associate-dm'}, {name: 'Decision', next: 'publish', prev: 'executive', activity: 'decision', role: 'minister'}, {name: 'Publishing', next: '', prev: 'decision', activity: 'publish', role: 'assessment-admin'}]},
];
