...
var artifacttypes = [
    { name: 'Application', phase: '', multiple: false, isTemplate: false, isDocument: true, code: 'application', milestone: 'application', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    //{ name: 'Decision Package', phase: 'decision', code: 'decision-package', milestone: 'decision-package', multiple: false, isTemplate: true, isDocument: false, versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    { name: 'Documents', phase: '', multiple: true, isTemplate: false, isDocument: false, code: 'documents', milestone: 'documents', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    //{ name: 'Environmental Assessment Certificate Template', phase: '', milestone: 'environmental-assessment-certificate',code: 'environmental-assessment-certificate',multiple: false,versions: ['Draft','Final'], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    { name: 'Memo to the Minister from the Associate Deputy Minister', phase: 'review', multiple: false, isTemplate: false, isDocument:true, code: 'memo-adm', milestone: 'memo-adm', versions : [ 'Final'], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    { name: 'Recommendations of the Executive Director', phase: 'review', multiple: false, isTemplate: false, isDocument: true, code: 'memo-epd', milestone: 'memo-epd', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
    //{ name: 'Referral Package', phase: 'review', code: 'referral-package', milestone: 'referral-package', multiple: false, isTemplate: true, isDocument: false, versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publish', next: '', prev: 'edit', activity: 'publish', role: 'project-admin'}]},
];
