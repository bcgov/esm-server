...
var artifacttypes = [
    { name: 'Application', phase: '', multiple: false, isTemplate: false, isDocument: true, code: 'application', milestone: 'application', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'approve', prev: '', activity: 'edit'}, {name: 'Approval', next: 'publish', prev: 'edit', activity: 'approve', role: 'assessment-lead'}, {name: 'Publishing', next: '', prev: 'approve', activity: 'publish', role: 'assessment-admin'}]},
    ...
    { name: 'Documents', phase: '', multiple: true, isTemplate: false, isDocument: false, code: 'documents', milestone: 'documents', versions : [ 'Final' ], stages: [{name: 'Edit', next: 'publish', prev: '', activity: 'edit'}, {name: 'Publishing', next: '', prev: 'edit', activity: 'publish', role: 'assessment-admin'}]},
