...
searchResultsDocumentDirective.$inject = ['_', 'AlertService', 'SearchService', 'SearchResultsService', '$rootScope', 'Authentication'];
/* @ngInject */
function searchResultsDocumentDirective(_, AlertService, SearchService, SearchResultsService, $rootScope, Authentication) {
  return {
    restrict: 'E',
    scope: {
      project: '=',
    ...
    controller: function ($scope) {
      ...
      self.copyClipboardError = function() {
