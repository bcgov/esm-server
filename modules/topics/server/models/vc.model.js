...
var assessmentBoundarySchema = new mongoose.Schema ({
...
var existingConditionsSchema = new mongoose.Schema ({
	description : { type:String, default:'' },
	analysis    : { type:String, default:'' },
	documents   : [ { type:'ObjectId', ref:'Document'} ]
});
var potentialEffectsSchema = new mongoose.Schema ({
	analysis     : { type:String, default:'' },
...
var mitigationMeasuresSchema = new mongoose.Schema ({
...
var cumulativeEffectsSchema = new mongoose.Schema ({
...
.generateModel ('ValuedComponent', {
	...
	assessmentBoundaries : [assessmentBoundarySchema],
	existingConditions   : [existingConditionsSchema],
	potentialEffects     : [potentialEffectsSchema],
	mitigationMeasures   : [mitigationMeasuresSchema],
	residualEffects      : {
	...
	cumulativeEffects: [cumulativeEffectsSchema],
	followUpStrategy : {
		description : { type:String, default:'' },
		analysis    : { type:String, default:'' }
	}
