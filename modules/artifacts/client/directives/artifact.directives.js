      ...
      controller: function ($scope, NgTableParams, Authentication, _, PhaseBaseModel) {
        ...
        s.openAddTypes = function () {
          ...
          var modalDocView = $uibModal.open({
            ...
            controller: function ($uibModalInstance, $scope, NgTableParams, Authentication, PhaseBaseModel, _, $stateParams, ArtifactModel) {
              var chooser = this;
              chooser.current = [];
              chooser.currentObjs = [];
...
//
// -------------------------------------------------------------------------
  .directive('artifactChooser', function ($uibModal) {
    return {
      restrict: 'A',
      scope: {
        project: '=',
  ...
  .directive('artifactVc', function ($uibModal, ArtifactModel, _) {
    return {
      restrict: 'A',
      scope: {
        project: '=',
