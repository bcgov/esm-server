          ...
          routes.moveFile (opts)
            .then (function (newFilePath) {
              ...
              if (req.headers.internaldocument) {
                ...
                readPermissions = ['project-admin', 'assessment-lead', 'assessment-team', 'complaince-officer', 'complaince-lead', 'system-eao', 'project-team', 'project-intake', 'project-system-admin'];
              }
