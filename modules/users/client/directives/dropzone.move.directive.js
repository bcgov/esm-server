...
angular.module('documents')
	.directive('dropzoneMove', ['$rootScope', '$modal', '$log', '$timeout', '$animate', '_', 'moment', 'Authentication', 'DocumentMgrService', 'TreeModel', 'ProjectModel', 'Document', function ($rootScope, $modal, $log, $timeout, $animate, _, moment, Authentication, DocumentMgrService, TreeModel, ProjectModel, Document) {
		return {
			restrict: 'A',
			scope: {
				project: '=',
			...
			resolve: {
				rootNode: function(ProjectModel, project) {
					console.log("resolve    project.directoryStructure",project.directoryStructure);
					 ...
					 .then( function (dir) {
						 ...
						 var rootNode = tree.parse(project.directoryStructure);
						 console.log("resolve   rootNode",rootNode);
						 return rootNode;
					 });
				}
			},
