...
function directiveProjectDescriptionRead(ProjectDescriptionModel) {
	var directive = {
		restrict: 'E',
		templateUrl: 'modules/projectDescription/client/views/project-description-read.html',
...
function directiveProjectDescriptionEdit(ProjectDescriptionModel) {
	var directive = {
		restrict: 'E',
		templateUrl: 'modules/projectDescription/client/views/project-description-edit.html',
