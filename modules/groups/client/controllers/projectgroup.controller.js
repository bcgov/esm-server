...
angular
	.module('groups', [])
	.controller('GroupEditController', ['$scope', '$state', '$uibModal', 'Authentication', 'NgTableParams',  '_', 'ProjectGroupModel', 'project', 'group', 'mode', 'CodeLists', function GroupEditController($scope, $state, $uibModal, Authentication, NgTableParams,  _, ProjectGroupModel, project, group, mode, CodeLists) {
