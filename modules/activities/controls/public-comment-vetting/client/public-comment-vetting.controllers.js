...
angular.module('control')
	.controller('controllerProcessPublicCommentVetting', controllerProcessPublicCommentVetting);
...
//
// -----------------------------------------------------------------------------------
controllerProcessPublicCommentVetting.$inject = ['$scope', '$rootScope', '_', 'PublicCommentVetting', 'COMMENT_REJECT'];
	//
function controllerProcessPublicCommentVetting($scope, $rootScope, _, PublicCommentVetting, COMMENT_REJECT) {
