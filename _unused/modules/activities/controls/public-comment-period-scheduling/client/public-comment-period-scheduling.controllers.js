...
angular.module('control')
	.controller('controllerProcessPublicCommentPeriodScheduling', controllerProcessPublicCommentPeriodScheduling);
...
//
// -----------------------------------------------------------------------------------
controllerProcessPublicCommentPeriodScheduling.$inject = ['$scope', '$rootScope', 'moment', 'Project', '_'];
	//
function controllerProcessPublicCommentPeriodScheduling($scope, $rootScope, moment, Project, _) {
	...
	taskPubComSched.saveProcess = function() {
		//save this task
	...
	taskPubComSched.completeProcess = function() {
		taskPubComSched.saveProcess();
		$rootScope.$broadcast('resolveProcess', taskPubComSched.task);
	};
